...
import rampaImage from "../assets/RAMPA.png"


const MapaRampa = (props) => {
  ...
  const handleSolicitudRampa = () => {
    ...
    console.log('Coordenadas:', selectedLocation);
      console.log('Direccion a enviar:', results[0].formatted_address);
      props.navigation.navigate('Solicitud Rampa', { direccionRampa: results[0].formatted_address, lugarId: selectedPlaceId, location: selectedLocation });
    } else {
 ...
 const googleApiUrl = "https://maps.googleapis.com/maps/api/place/textsearch/json"
    ...
    try {
      ...
      console.log("respuesta json", json.results)
      if (json && json.results){
        ...
        for ( const item of json.results){
          ...
          console.log("No sé que es esto", item.name)
          console.log("esto debe ser la respuesta en direccion",item.geometry)
        }
      ...
      const response = await axios.post("https://2lfj6g4k-3000.brs.devtunnels.ms/rampas/direcciones", 
      
       {
         direccionRampa: json.results[0].formatted_address,
       location: {
  ...
  return (
    <View>
        ...
        <TouchableOpacity style={styles.circle} onPress={handleSolicitudRampa}>
        <View style={styles.circleImage}>
          <Image source={rampaImage} style={styles.circleImage} />
        </View>
      </TouchableOpacity>
